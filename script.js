    ...
    if (contactForm) {
        ...
        function validateField(field) {
            ...
            if (value && rules.minLength && value.length < rules.minLength) {
                field.classList.add('invalid');
                if (errorElement) errorElement.textContent = rules.message;
                return false;
            }
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            if (!isValid) {
                showFormMessage(contactForm, 'error', 'Please correct the errors before submitting.');
                const firstInvalid = contactForm.querySelector('.invalid');
                if (firstInvalid) firstInvalid.focus();
                return;
            }
            
            showFormMessage(contactForm, 'success', 'Form submitted successfully!');
            contactForm.reset();
...
(function(){
  ...
  var CINEMATIC_HERO_ENABLED = true;
...
/* SIGNATURE MOMENT: tilt-cards */
(function(){

      (function(){
        if (window.matchMedia && window.matchMedia('(prefers-reduced-motion: reduce)').matches) return;
        if (window.matchMedia && !window.matchMedia('(pointer: fine)').matches) return;
        var cards = document.querySelectorAll('.card, .feature-card, [class*="-card"], article[class*="card"]');
        Array.prototype.slice.call(cards, 0, 60).forEach(function(el){
          el.classList.add('zsm-tilt');
          el.addEventListener('mousemove', function(e){
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '4aab0942-ded9-4843-b59d-2a47efec0072',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '4aab0942-ded9-4843-b59d-2a47efec0072';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '4aab0942-ded9-4843-b59d-2a47efec0072';
